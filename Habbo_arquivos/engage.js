...
if (typeof janrain.settings.common.appUrl === 'undefined')janrain.settings.common.appUrl = "https://login.habbo.com";
...
if (typeof janrain.settings.backgroundColor === 'undefined')janrain.settings.backgroundColor = "#e2e2e2";
if (typeof janrain.settings.buttonBorderColor === 'undefined')janrain.settings.buttonBorderColor = "#c7c7c7";
if (typeof janrain.settings.buttonBorderRadius === 'undefined')janrain.settings.buttonBorderRadius = 3;
...
if (typeof janrain.settings.borderColor === 'undefined')janrain.settings.borderColor = "#000000";
if (typeof janrain.settings.borderRadius === 'undefined')janrain.settings.borderRadius = 10;
if (typeof janrain.settings.appId === 'undefined')janrain.settings.appId = "dimljjkficobnkmcooba";
if (typeof janrain.settings.appUrl === 'undefined')janrain.settings.appUrl = "https://login.habbo.com";
janrain.settings.permissions = ["customizable_auth_widget_styling", "customizable_auth_widget_hide_attribution"];
if (typeof janrain.settings.providers === 'undefined')janrain.settings.providers = ["googleplus", "yahoo-oauth2", "twitter", "microsoftaccount"];
...
if (typeof janrain.settings.share.appUrl === 'undefined')janrain.settings.share.appUrl = "https://login.habbo.com";
janrain.settings.share.permissions = ["customizable_share_widget_styling", "customizable_share_widget_contact_mode", "customizable_share_widget_hide_attribution", "customizable_share_widget_email_mode"];
